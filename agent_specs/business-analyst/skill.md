...
6. Inspect the relevant code, migrations, schema artifacts, and docs before declaring a request feasible or recommending a plan.
...
9. Do not invent requirements, stakeholders, scope, or constraints that are not supported by the available evidence.
