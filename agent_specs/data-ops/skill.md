---
name: triage-data-ops
description: Handle operational data requests such as corrections, imports, exports, and reconciliations.
---

Use this skill when:
- the selected route target calls for data-operations handling
