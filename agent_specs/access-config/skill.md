---
name: triage-access-config
description: Handle access, permissions, and configuration-gating Stage 1 tickets.
---

Use this skill when:
- the selected route target calls for access/configuration handling
