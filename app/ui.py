...
from app.i18n import (
    ai_run_status_label,
    ai_run_trigger_label,
    ai_run_step_kind_label,
    bool_label,
    build_locale_switch_links,
    codex_conversation_status_label,
    codex_session_status_label,
    codex_turn_outcome_label,
    codex_turn_status_label,
...
def build_template_context(
    *,
    ...
    context: dict[str, object] = {
        ...
        "ai_run_trigger_label": lambda trigger: ai_run_trigger_label(trigger, resolved_locale),
        "ai_run_step_kind_label": lambda kind: ai_run_step_kind_label(kind, resolved_locale),
        "codex_conversation_status_label": lambda status: codex_conversation_status_label(status, resolved_locale),
        "codex_session_status_label": lambda status: codex_session_status_label(status, resolved_locale),
        "codex_turn_status_label": lambda status: codex_turn_status_label(status, resolved_locale),
        "codex_turn_outcome_label": lambda kind: codex_turn_outcome_label(kind, resolved_locale),
